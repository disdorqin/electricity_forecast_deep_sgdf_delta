...
def main():
    ...
    parser.add_argument("--target-month", type=str, required=True, help="e.g. 2026-02")
    ...
    logger.info("=" * 60)
    logger.info("Solar916 Residual Training — Phase 7")
    logger.info("=" * 60)
    ...
    from models.deep_sgdf_delta.solar916_model import (
        Solar916Config, train_walk_forward, smape_floor50 as smape_fn,
    )
    ...
    # ── Train ────────────────────────────────────────────────────────
    config = Solar916Config(model_type=args.model_type)
